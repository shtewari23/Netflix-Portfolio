...
const topPicksConfig = {
  recruiter: [
    { title: "Skills", imgSrc: skill1, icon: <FaCode />, route: "/skills" },
    { title: "Experience", imgSrc: experience, icon: <FaBriefcase />, route: "/work-experience" },
    { title: "Projects", imgSrc: project, icon: <FaProjectDiagram />, route: "/projects" },
      ...
      {topPicks.map((pick, index) => (
          ...
          >
            ...
            <div className="overlay">
              <div className="pick-label" style={{fontSize:'20px'}}>{pick.title}</div>
            </div>
          </div>
        ))}
      </div>
